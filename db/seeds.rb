...
Recruiter.create(name: 'Irene Jane', image: 'https://cdn1.iconfinder.com/data/icons/user-pictures/100/female1-512.png', company_id: company1.id, job_id: job1.id
Recruiter.create(name: 'Irene Jane', image: 'https://cdn1.iconfinder.com/data/icons/user-pictures/100/female1-512.png', company_id: company1.id, job_id: job3.id

Recruiter.create(name: 'Paul Peter', image: 'https://thumbs.dreamstime.com/b/male-avatar-icon-flat-style-male-user-icon-cartoon-man-avatar-hipster-vector-stock-91462914.jpg', company_id: company2.id, job_id: job2.id
Recruiter.create(name: 'Paul Peter', image: 'https://thumbs.dreamstime.com/b/male-avatar-icon-flat-style-male-user-icon-cartoon-man-avatar-hipster-vector-stock-91462914.jpg', company_id: company2.id, job_id: job5.id

Recruiter.create(name: 'Dave Collins', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlvapOOKTYbJNRayZFsm-7FFJG5_MOVnrfWQ&usqp=CAU', company_id: company3.id, job_id: job3.id
Recruiter.create(name: 'Dave Collins', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlvapOOKTYbJNRayZFsm-7FFJG5_MOVnrfWQ&usqp=CAU', company_id: company3.id, job_id: job4.id